...
<template>
	<section class="section">
		<BaseContainer>
			<SectionContainer>
				<SectionHeader>Напишите нам</SectionHeader>
				<SectionText>
					Если захотели
					<br />
					поработать с нами
			...
			<div class="social-links">
				<a href="https://vk.com/community42_agency" target="_blank">
					<img alt="" src="@/assets/svg/social-link__vk.svg" />
				</a>
				<a href="https://t.me/Ilia_Ekimov" target="_blank">
					<img alt="" src="@/assets/svg/social-link__tg.svg" />
				</a>
				<a href="https://wa.me/qr/PFF7NWMI5KA4F1" target="_blank">
					<img alt="" src="@/assets/svg/social-link__wa.svg" />
				</a>
				<a href="">
